...
# headers = {
#     "Authorization": "Bearer c3a06ac3-d03a-4154-8a58-7cbf05aba18b",
...
# below not working always with error ( unless with async, but with async, result not given, unless use curl, if python sdk it fails)
"""
> ## Documentation Index
